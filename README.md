...
A CRUD app that uses the Sequelize ORM.<br> At the moment still in the planning phase.
But ultimately, the project will be a basic inventory management application for fasteners.
